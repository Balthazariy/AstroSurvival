...
namespace TandC.RunIfYouWantToLive
{
    public class VFXController : IController
    {
        ...
        public void Init()
        {
            ...
            _inputManager.OnLeftMouseButtonClickEvent += PlayClickVFX;
            _inputManager.OnLeftMouseButtonOnUIClickEvent += PlayUIClickVFX;
        ...
        public void PlayClickVFX(Vector2 worldPosition)
        {
            GameObject vfx = MonoBehaviour.Instantiate(_loadObjectsManager.GetObjectByPath<GameObject>("Prefabs/Gameplay/VFX/ClickVFX"), _parentOfAllVFX);
            vfx.transform.position = worldPosition;
        }

        public GameObject SpawnRocketBlow(Vector2 worldPosition)
        {
        ...
        public void SpawnDomagePointVFX(Vector2 worldPosition, float damageValue, Color textColor)
        {
            ...
            textItem.text = damageValue.ToString();
        ...
        public void PlayUIClickVFX(Vector2 worldPosition)
        {
            //GameObject vfx = MonoBehaviour.Instantiate(_loadObjectsManager.GetObjectByPath<GameObject>("Prefabs/Gameplay/VFX/ClickUIVFX"));
            //vfx.transform.position = new Vector3(worldPosition.x, worldPosition.y, 0);
        }
